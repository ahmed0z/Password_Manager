...
export function getThemeStyles(theme: 'dark' | 'light') {
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    itemTitle: { fontSize: '16px', fontWeight: 600, color: c.text, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
    itemTitleDark: { fontSize: '16px', fontWeight: 600, color: '#1F2228', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
    itemSub: { fontSize: '13px', color: c.textSec, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', marginTop: '2px' },
    itemSubDark: { fontSize: '13px', color: '#6B7280', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', marginTop: '2px' },
    iconBtn: {
    ...
    statPill: {
      ...
      background: c.card, border: `1px solid ${c.cardBorder}`,
      textAlign: 'center', minWidth: '70px', cursor: 'pointer',
    },
    statPillActive: {
      flex: 1, padding: '10px 14px', borderRadius: '999px',
